...
Regression model without interaction has shown lower BIC and AIC. Therefore, we decided to choose this model.
...
# kable(BIC(reg23_lm, reg31_lm), caption = "Comparing models, BIC")
# kable(AIC(reg23_lm, reg31_lm), caption = "Comparing models, AIC")

t_BIC <- BIC(reg23_lm, reg31_lm)
t_AIC <- AIC(reg23_lm, reg31_lm)
knitr::kable(list(t_BIC, t_AIC))

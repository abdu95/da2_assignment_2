...
chck_sp(df$Lot.Shape.fact, "General shape of property", "", "The more regular shape house has, the higher the price. But some Irregular houses has same price as Regular houses")
```
...
chck_sp(df$Garage.Area, "Garage Area", "", "Almost positive linear, but some outliers at the end causing the line to curve. Seems Garage Area variable is important")
```
